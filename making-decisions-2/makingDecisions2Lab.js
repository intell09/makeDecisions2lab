...
//Code Here
let lastItemRemoved = [10, 20, 30, 40, 50, 60];
let finalName = lastItemRemoved.pop();
...
if (90 < A) {
    console.log("A");
} else if ((80, 81, 82, 83, 84, 85, 86, 87, 88, 89 < B)) {
    console.log("B");
} else if ((70, 71, 72, 73, 74, 75, 76, 77, 78, 79 < C)) {
    console.log("C");
} else if ((60, 61, 62, 63, 64, 65, 66, 67, 68, 69 < D)) {
    console.log("D");
} else if (50 < F) {
    console.log("F");
}
